...
class AppSearchClient {
   ...
   */
  static createSignedSearchKey(apiKey, apiKeyName, options = {}, jwtOptions = {}) {
    const payload = Object.assign({}, options, { api_key_name: apiKeyName })
    return jwt.sign(payload, apiKey, Object.assign({}, jwtOptions, { algorithm: SIGNED_SEARCH_TOKEN_JWT_ALGORITHM }))
  }
}
